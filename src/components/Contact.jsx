...
//CzmTVgmjrCZskuUNP
    ...
    emailjs.send(
      ...
      'template_r2kzn9f',
      {
        ...
        to_email:'anuragkumar959593@gamil.com',
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden' >
      ...
      >
        ...
        >
          ...
          <button className='bg-tertiary py-3 px-8 outline-none w-fit text-white shadow-primary shadow-md font-bold rounded-xl' type='submit'>
